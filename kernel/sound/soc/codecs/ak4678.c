...
/* ak4678.h will contain belows */
#define SND_SOC_DAIFMT_SFS	7
#define SND_SOC_DAIFMT_LFS	8

/* AK4678 Hook-up function for using sub module */
int ak4678_hookup_probe(struct device *dev);
/* finish header file contains */
...
#define MIX_CTRL2	0x27
#define MIX_CTRL3	0x28
...
static const char *ak4678_sdo_src[] = {
	"ADC", "MIX1", "ADC + MIX1" , "(ADC + MIX1) / 2"
};

static const char *ak4678_pfsdo_src[] = {
	"ADC", "PFilter"
};
...
SOC_ENUM_SINGLE(MIX_CTRL3, 4, 4, ak4678_sdo_src),
SOC_ENUM_SINGLE(MIX_CTRL3, 6, 4, ak4678_sdo_src),
SOC_ENUM_SINGLE(DFLT_SEL0, 1, 2, ak4678_pfsdo_src),
};
...
static const struct snd_kcontrol_new ak4678_sdo[] = {
SOC_DAPM_ENUM("SDOL", ak4678_enum[6]),
SOC_DAPM_ENUM("SDOR", ak4678_enum[7])
};

static const struct snd_kcontrol_new ak4678_pfsdo =
SOC_DAPM_ENUM("PFSDO", ak4678_enum[8]);
...
SND_SOC_DAPM_MUX("PFSDO", SND_SOC_NOPM, 0, 0, &ak4678_pfsdo),

SND_SOC_DAPM_ADC("SDOD", "Capture", IF_FMT_SEL, 4, 1),

SND_SOC_DAPM_MUX("SDOL", SND_SOC_NOPM, 0, 0, &ak4678_sdo[0]),
SND_SOC_DAPM_MUX("SDOR", SND_SOC_NOPM, 0, 0, &ak4678_sdo[1]),

SND_SOC_DAPM_ADC("ADC", "Capture", SND_SOC_NOPM, 0, 0),
SND_SOC_DAPM_PGA("PMADL", POWER_MAN0, 4, 0, NULL, 0),
SND_SOC_DAPM_PGA("PMADR", POWER_MAN0, 5, 0, NULL, 0),

SND_SOC_DAPM_SUPPLY("PMMP1", POWER_MAN2, 0, 0, NULL, 0),
SND_SOC_DAPM_SUPPLY("PMMP2", POWER_MAN2, 2, 0, NULL, 0),
...
static const struct snd_soc_dapm_route ak4678_route_path[] = {
	...
	{"SDOL", "ADC", "PFSDO"},
	{"SDOL", "ADC + MIX1", "PFSDO"},
	{"SDOL", "(ADC + MIX1) / 2", "PFSDO"},
	{"SDOR", "ADC", "PFSDO"},
	{"SDOR", "ADC + MIX1", "PFSDO"},
	{"SDOR", "(ADC + MIX1) / 2", "PFSDO"},
				...
				enum snd_soc_bias_level level)
{
	...
	case SND_SOC_BIAS_PREPARE:
		snd_soc_update_bits(codec, POWER_MAN0, 0x1, 0x1);
		break;
	...
	case SND_SOC_BIAS_OFF:
		snd_soc_update_bits(codec, POWER_MAN0, 0x1, 0x0);
		break;
	}
