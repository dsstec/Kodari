/*
 *  linux/arch/arm/mach-exynos/kodari-gpio.c
 *
...
static struct gpio_init_data kodari_init_gpios[] = {
	{EXYNOS4_GPX0(0), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE,
			S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* GPIO_WIPE_EN */
	
	{EXYNOS4_GPX0(1), S3C_GPIO_SFN(0xF), S3C_GPIO_SETPIN_NONE,
			S3C_GPIO_PULL_UP, S5P_GPIO_DRVSTR_LV1}, /* GPIO_TOUCH_INT */			
#if defined(CONFIG_KODARI_TYPE_MOBILE)
	{EXYNOS4_GPX0(3), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ZERO,
			S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* GPIO_5V_EN_L for moblie type*/
#endif
	{EXYNOS4_GPX0(4), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ZERO,
			S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* GPIO_TOUCH_nRST_L*/
	{EXYNOS4_GPX0(5), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ONE,
			S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* GPIO_USB_HUB_1_2_nRST_H*/
	{EXYNOS4_GPX0(7), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ONE,
			S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* GPIO_GPS_nRST_H*/
	{EXYNOS4_GPX1(3), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE,
			S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* GPIO_POWER_KEY*/		
			

	{EXYNOS4_GPX2(2), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE,
			S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* sata 51 pin*/		

	{EXYNOS4_GPX2(3), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE,
			S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* magnetic & accel sense INT2 */		

	{EXYNOS4_GPX2(4), S3C_GPIO_SFN(0xF), S3C_GPIO_SETPIN_NONE,
			S3C_GPIO_PULL_UP, S5P_GPIO_DRVSTR_LV1}, /* GPIO_ETHERNET_INT */		
#if defined(CONFIG_KODARI_TYPE_CAR)
	{EXYNOS4_GPX2(5), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE,
				S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* GPIO_DCJACK_IN */ 	
#endif

	{EXYNOS4_GPX3(0), S3C_GPIO_SFN(0xF), S3C_GPIO_SETPIN_NONE,
				S3C_GPIO_PULL_UP, S5P_GPIO_DRVSTR_LV1}, /* GPIO_EAR_JACT_DET */ 	

	{EXYNOS4_GPX3(1), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE,
				S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* magnetic & accel sense INT3 */ 	

	{EXYNOS4_GPX3(2), S3C_GPIO_SFN(0xF), S3C_GPIO_SETPIN_NONE,
				S3C_GPIO_PULL_UP, S5P_GPIO_DRVSTR_LV1}, /* GPIO_PIMC_INT*/ 	


	{EXYNOS4_GPX3(3), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE,
					S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* magnetic & accel sense DRDY*/	

	{EXYNOS4_GPX3(4), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE,
					S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* magnetic & accel sense INT1*/	
#if defined(CONFIG_KODARI_TYPE_CAR)
	{EXYNOS4_GPX3(6), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE,
					S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* GPIO_HDMI_CEC*/	
	{EXYNOS4_GPX3(7), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE,
					S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* GPIO_HDMI_DETECT*/	
#endif
	{EXYNOS4_GPD1(0), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE,
			S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* PMIC_SDA_1.8V */
	{EXYNOS4_GPD1(1), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE,
			S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* PMIC_SCL_1.8V */

	{EXYNOS4_GPD1(2), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE,
				S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* CAMERA_SDA_1.8V */
	{EXYNOS4_GPD1(3), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE,
				S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* CAMERA_SCL_1.8V */
#if defined(CONFIG_KODARI_TYPE_MOBILE)
	{EXYNOS4_GPC0(0), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ZERO,
				S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* GPIO_VIBRATOR_EN */
#endif

	{EXYNOS4_GPC0(1), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ONE,
				S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* GPIO_LVDS_nRST_L*/

			
	{EXYNOS4_GPK0(2), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ZERO,
		S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV2}, /* GPIO_WIFI_LDO18_BUCK9_EN_H */

	{EXYNOS4_GPK2(2), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ZERO,
		S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV4}, /* GPIO_WIFI_EN_L */

		
	{EXYNOS4_GPD0(0), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE,
		S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* Buzzer PWM */

	{EXYNOS4_GPD0(1), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE,
		S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* LCD PWM */

	{EXYNOS4_GPD0(2), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE,
		S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* micom sda */	
	{EXYNOS4_GPD0(3), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE,
		S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* micom scl */

	{EXYNOS4_GPB(0), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE,
		S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* Magnetic & accel sensor SDA 4*/
	{EXYNOS4_GPB(1), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE,
		S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* Magnetic & accel sensor SCL 4 */

	{EXYNOS4_GPB(2), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE,
		S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* touch SDA 5 */
	{EXYNOS4_GPB(3), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE,
		S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* touch SCL 5 */

	{EXYNOS4_GPA0(6), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE,
		S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* hdmi edid SDA 2 */	
	{EXYNOS4_GPA0(7), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE,
		S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* hdmi edid SCL 2 */


	{EXYNOS4_GPY2(0), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ZERO,
		S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* GPIO_PMIC_BUCK6_EN_H */

	{EXYNOS4212_GPJ1(3), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE,
		S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* CAMER CIF_MCLK */

	{EXYNOS4212_GPJ0(0), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE,
		S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* CAMER CIF_PCLK */


	{EXYNOS4_GPL0(0), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ZERO,
			S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* GPIO_PMIC_DS2 */
	{EXYNOS4_GPL0(1), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ZERO,
		S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* GPIO_PMIC_DS3 */
	{EXYNOS4_GPL0(2), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ZERO,
		S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* GPIO_PMIC_DS4 */
	{EXYNOS4_GPL0(3), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ZERO,
		S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* GPIO_PMIC_DVS1 */		
	{EXYNOS4_GPL0(4), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ZERO,
		S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* GPIO_PMIC_DVS2 */
	{EXYNOS4_GPL0(6), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ZERO,
		S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* GPIO_PMIC_DVS3 */


	{EXYNOS4212_GPM3(4), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ZERO,
		S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* GPIO_ETHERNET_nRST_L */
#if defined(CONFIG_KODARI_TYPE_CAR)
	{EXYNOS4212_GPM4(1), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_ZERO,
		S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* GPIO_HDMI_nRST_L */
#endif

	{EXYNOS4212_GPM4(2), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_NONE,
		S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* GPIO_MSATA_WRITE_PROTECT_L */
	{EXYNOS4212_GPM4(3), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_NONE,
		S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* GPIO_MSATA_SECURE_ERASE_L */


	{EXYNOS4212_GPM4(4), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_NONE,
		S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* GPIO_CAM_nRST_L */
	{EXYNOS4212_GPM4(5), S3C_GPIO_OUTPUT, S3C_GPIO_SETPIN_NONE,
			S3C_GPIO_PULL_NONE, S5P_GPIO_DRVSTR_LV1}, /* GPIO_CAM_POWER_DOWN_H */
};
...
void kodari_config_sleep_gpio_table(void)
{
#ifdef CONFIG_MIDAS_COMMON
#if defined(CONFIG_MACH_M0_GRANDECTC)
...
void kodari_config_gpio_table(void)
{
	u32 i, gpio;
...
#else
	for (i = 0; i < ARRAY_SIZE(kodari_init_gpios); i++) {
		gpio = kodari_init_gpios[i].num;
		if (!soc_is_exynos4210()) {
			if (gpio <= EXYNOS4212_GPV4(1)) {
				s3c_gpio_cfgpin(gpio, midas_init_gpios[i].cfg);
				s3c_gpio_setpull(gpio, midas_init_gpios[i].pud);

				if (kodari_init_gpios[i].val != S3C_GPIO_SETPIN_NONE)
					gpio_set_value(gpio, kodari_init_gpios[i].val);

				s5p_gpio_set_drvstr(gpio, kodari_init_gpios[i].drv);
			}
		} else {
			if (gpio <= EXYNOS4210_GPJ1(4)) {
				s3c_gpio_cfgpin(gpio, kodari_init_gpios[i].cfg);
				s3c_gpio_setpull(gpio, kodari_init_gpios[i].pud);
