...
void exynos4_gpio_conpdn_reg(void)
#else
static exynos4_gpio_conpdn_reg(void)
#endif
{
				    ...
				    struct cpuidle_state *state)
{
	...
	if (!soc_is_exynos4210()) {
		...
		//exynos4x12_set_abb_member(ABB_ARM, ABB_MODE_060V);
	}
				   ...
				   struct cpuidle_state *state)
{
	...
	if (!soc_is_exynos4210()) {
		...
		//leehc
		exynos4x12_set_abb_member(ABB_ARM, ABB_MODE_085V);
		exynos4x12_set_abb_member(ABB_INT, ABB_MODE_085V);
		//exynos4x12_set_abb_member(ABB_ARM, ABB_MODE_060V);
		//exynos4x12_set_abb_member(ABB_INT, ABB_MODE_060V);
	}
