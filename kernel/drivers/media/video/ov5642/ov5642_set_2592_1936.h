#ifndef __OV5642_SET_2592_1536_H__
#define __OV5642_SET_2592_1536_H__

static unsigned short ov5642_init_2592_1936[][2] = {
...
{0x3011, 0x08}, {0x3010, 0x00}, {0x3604, 0x60},
...
{0x302b, 0x00}, {0x460c, 0x20}, {0x460b, 0x37},
{0x471c, 0xd0}, {0x471d, 0x05}, {0x3815, 0x01},
{0x3818, 0xc0}, {0x501f, 0x00}, {0x4300, 0x30},
{0x3002, 0x1c}, {0x3819, 0x80}, {0x5002, 0xe0},
{0x3012, 0x01},                                

};

#define OV5642_5MPIX_INIT_REGS	\
	(sizeof(ov5642_init_2592_1936) / sizeof(ov5642_init_2592_1936[0]))

#endif //__OV5642_SET_2592_1936_H__
