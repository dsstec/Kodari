#ifndef __OV5642_SET_1920_1080_H__
#define __OV5642_SET_1920_1080_H__

static unsigned short ov5642_init_1920_1080[][2] = {
...
{0x302b, 0x00}, {0x3503, 0x07}, {0x3011, 0x07},
{0x350c, 0x04}, {0x350d, 0x58}, {0x3801, 0x8a},
{0x3803, 0x0a}, {0x3804, 0x07}, {0x3805, 0x80},
{0x3806, 0x04}, {0x3807, 0x38}, {0x3808, 0x07},
{0x3809, 0x80}, {0x380a, 0x04}, {0x380b, 0x38},
{0x380c, 0x09}, {0x380d, 0xd6}, {0x380e, 0x04},
{0x380f, 0x58}, {0x381c, 0x11}, {0x381d, 0xba},
{0x381e, 0x04}, {0x381f, 0x48}, {0x3820, 0x04},
{0x3821, 0x18}, {0x3a08, 0x14}, {0x3a09, 0xe0},
{0x3a0a, 0x11}, {0x3a0b, 0x60}, {0x3a0d, 0x04},
{0x3a0e, 0x03}, {0x5682, 0x07}, {0x5683, 0x60},
{0x5686, 0x04}, {0x5687, 0x1c}, {0x5001, 0x7f},
{0x3503, 0x00}, {0x3010, 0x00}, {0x460c, 0x20},
{0x460b, 0x37}, {0x471c, 0xd0}, {0x471d, 0x05},
{0x3815, 0x01}, {0x3818, 0x00}, {0x501f, 0x00},
{0x4300, 0x30}, {0x3002, 0x1c}, {0x3819, 0x80},
{0x5002, 0xe0},                                

};

#define OV5642_1080P_INIT_REGS	\
	(sizeof(ov5642_init_1920_1080) / sizeof(ov5642_init_1920_1080[0]))

#endif //__OV5642_SET_1920_1080_H__
