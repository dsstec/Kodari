...
#ifdef CONFIG_KODARI_USB_RESTRICT // Restrict USB Device except allowed Product/Vendor ID
{USB_DEVICE(0x0451, 0x9260)}, // SSD of KODARI
#else
...
#	include "unusual_smsc_usb4640.h"
	{ }		/* Terminating entry */
};
