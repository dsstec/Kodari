...
#define SWITCH_CSR_CMD_CSR_BUSY_	0x80000000
#define SWITCH_CSR_CMD_R_NOT_W_		0x40000000
#define SWITCH_CSR_CMD_BYTE_ENABLE_  0x000F0000
#define SWITCH_CSR_CMD_CSR_ADDR_	0x0000FFFF



#define SWE_GLOBAL_INGRSS_CFG  0x1840
#define VLAN_WR_DATA 0x180C
#define VLAN_RD_DATA 0x180E

#define	VLAN_CMD_REG 0x180B
#define VLAN_CMD_STS 0x1810
#define	VLAN_PVID_SELECT_ BIT(4)
#define	VLAN_CMD_R_NOT_W_ BIT(5)


#define VLAN_DATA_MEMBER_PORT_0 BIT(13)
#define VLAN_DATA_UNTAG_PORT_0  BIT(12)


#define VLAN_DATA_MEMBER_PORT_1 BIT(15)
#define VLAN_DATA_UNTAG_PORT_1  BIT(14)

#define VLAN_DATA_MEMBER_PORT_2 BIT(17)
#define VLAN_DATA_UNTAG_PORT_2  BIT(16)


#define VLAN_ID_0 0x0
#define VLAN_ID_10 0xA
#define VLAN_ID_11 0xB
#define PVID_0 0x0
#define PVID_1 0x1
#define PVID_2 0x2
...
#define PORT_INGRSS_CFG 0x1841
#define ADMT_N_MEMBER_ADDR 0x1849
#define EGRSS_PORT_TYPE 0x1C0C
#define BM_VLAN_MII 0x1C13
#define BM_VLAN_1 0x1C14
#define BM_VLAN_2 0x1C15

#define ADMT_ONLY_VLAN 0x1842
