...
#define CONFIG_KODARI_TYPE_MOBILE //#define CONFIG_KODARI_TYPE_CAR
...
#define CONFIG_BOOTCOMMAND3	\
		...
		"echo format mmc 0:4;" \
		"ext3format mmc 0:4;" \
		"echo fat load bl1_kodari.bin from mmc 0:1;" \
		"fatload mmc 0:1 ${loadaddr} bl1_kodari.bin;" \
		"echo flashing bl1_kodari.bin to internal mmc;" \
		"fastboot flash fwbl1 ${loadaddr};" \
		"echo fat load bl2_kodari.signed from mmc 0:1;" \
		"fatload mmc 0:1 ${loadaddr} bl2_kodari.signed;" \
		"echo flashing bl2_kodari.signed to internal mmc;" \
		"fastboot flash bl2  ${loadaddr};" \
		"echo fat load tzsw_kodari.signed from mmc 0:1;" \
		"fatload mmc 0:1 ${loadaddr} tzsw_kodari.signed;" \
		"echo flashing tzsw_kodari.signed to internal mmc;" \
...
#define CONFIG_SYS_PROMPT		"KODARI # "
...
#define CONFIG_IDENT_STRING		" for KODARI"
